...
public class SearchResultSteps {
    ...
    public void i_see_in_search_result_page(String expectedTitle) {
        String actualTitle = new SearchResultPage(CommonSteps.getDriver()).getSearchResultTitle();
        Assert.assertEquals("Actual title and expected title not matching", actualTitle, expectedTitle);
    }
